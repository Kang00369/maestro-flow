...
If `maestro explore` is unavailable, stay in this read-only worker and use the
structural Bash scan only. Report the semantic-coverage gap to the coordinator;
do not create a nested Delegate or switch providers.
