...
const DEPRECATED_NAMES = [
  ...
  'teach-impeccable',   // folded into /maestro-impeccable teach
  // v2.1 merges
  'arrange',            // renamed to layout
  'normalize',          // merged into polish
  'onboard',            // merged into harden
  'extract',            // merged into /maestro-impeccable extract
  // v3.0 consolidation: all standalone skills -> /maestro-impeccable sub-commands
  'adapt',
  'animate',
  'audit',
  'bolder',
