...
The skill handles: context loading (PRODUCT.md/DESIGN.md), register detection (brand/product),
...
- [ ] Skill executed with context (PRODUCT.md loaded, register identified)
