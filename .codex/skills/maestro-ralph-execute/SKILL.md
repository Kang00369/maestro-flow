...
|------|-----------|------------|
| decision (ralph-only) | `load maestro-ralph/SKILL.md inline` — ralph re-evaluates | Execution ends here |
...
S_POST_EXEC:
  → S_LOCATE        DO: A_MARK_COMPLETE + self-invoke maestro-ralph-execute
