...
"RESEARCH-001","FastContext auth patterns","PURPOSE: Investigate authentication patterns in codebase | Success: Documented patterns with file references\nTASK:\n  - Use FastContext first for existing auth implementations\n  - Verify JWT/session/OAuth patterns with Grep/Read\n  - Document integration points\nCONTEXT:\n  - Key files: src/auth/**, src/middleware/**\nEXPECTED: Research findings with evidence\nCONSTRAINTS: Read-only analysis","researcher","","","1","always"
