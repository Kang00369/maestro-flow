...
|---------|-----------|--------|
| CLI | Complex multi-file changes | `maestro delegate --to grok --mode write --model grok-4.5 --effort high` |
...
CONSTRAINTS: Maintain existing code style" --to grok --mode write --model grok-4.5 --effort high`)
```
