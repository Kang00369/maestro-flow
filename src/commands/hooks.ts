...
export const CODEX_HOOK_LEVEL_DESCRIPTIONS: Record<HookLevel, string> = {
  ...
  standard: '+ spec/keyword-injector + skill-context + kg-sync + kg-auto-init(SessionStart) + kg-context-injector + delegate-monitor + coordinator/team/telemetry(Stop) + preflight/spec guards + csv-wave-guard + kg-unified-injector (opt-in)',
