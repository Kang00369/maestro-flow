...
9. Merge wave-{N}-results.csv into the master CSV.
10. Optional recovery check for hookless/interrupted runs:
...
11. Delete wave-{N}.csv
12. Return: updated master CSV rows
```
